...
// Check if on the notes page and select elements
if (window.location.pathname === '/notes') {
  ...
  if (!noteForm || !noteTitle || !noteText || !saveNoteBtn || !newNoteBtn || !clearBtn || !noteList.length) {
...
// Set and display the active note
...
// Get and render notes from the server
